...
CLI shape mirrors ``scripts/convert_no_3pov_to_v3.py`` so the three-stage
pipeline composes cleanly:

  python -m falsify.cli.combine_lerobot --src <atomic-parent> --out data/my_combined ...
  python scripts/strip_3pov.py            --dataset data/my_combined        --out data/my_combined_no_3pov
  python scripts/convert_no_3pov_to_v3.py --dataset data/my_combined_no_3pov --out data/my_combined_no_3pov_v3
