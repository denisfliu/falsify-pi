...
3. Invoke ``scripts/run_eval_campaign.py`` as a subprocess against that
...
Usage::
    ...
    bash -c 'export PI_API_KEY=...; source tools/env.sh; \\
        ...
        PYTHONPATH=src python scripts/run_cem_campaign.py \\
...
def _run_cem_for_scene(
    *,
    ...
    for it in range(n_iters):
        ...
        cmd = [
            sys.executable, str(REPO_ROOT / "scripts" / "run_eval_campaign.py"),
